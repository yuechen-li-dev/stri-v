...
public readonly record struct TransformParentAttachRequested(Entity Child, Entity Parent);
public readonly record struct TransformParentAttached(Entity Child, Entity Parent);
public readonly record struct TransformParentDetachRequested(Entity Child);
