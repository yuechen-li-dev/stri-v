...
$M1bSlnf = Join-Path $RepoRoot "build/StriV.EngineFoundation.M1b.slnf"

Write-Host "[striv-engine-foundation-m1b] Repo root: $RepoRoot"
Write-Host "[striv-engine-foundation-m1b] Configuration: $Configuration"
Write-Host "[striv-engine-foundation-m1b] AssemblyProcessor project: $ApProject"
Write-Host "[striv-engine-foundation-m1b] AssemblyProcessor output directory: $ApOutputDir"
Write-Host "[striv-engine-foundation-m1b] M1b solution filter: $M1bSlnf"

Write-Host "[striv-engine-foundation-m1b] Building AssemblyProcessor..."
...
Write-Host "[striv-engine-foundation-m1b] AssemblyProcessor payload validation passed (size=$($fileInfo.Length) bytes, header=MZ)."

Write-Host "[striv-engine-foundation-m1b] Building Stri-V Engine Foundation M1b..."
$buildArgs = @(
    "build", $M1bSlnf,
    "-c", $Configuration,
    "-v", "minimal",
...
Write-Host "[striv-engine-foundation-m1b] Build completed successfully."
exit 0
