...
M1A_SLNF="$REPO_ROOT/build/StriV.Core.M1a.slnf"

echo "[striv-core-m1a] Repo root: $REPO_ROOT"
echo "[striv-core-m1a] Configuration: $CONFIGURATION"
echo "[striv-core-m1a] AssemblyProcessor project: $AP_PROJECT"
echo "[striv-core-m1a] AssemblyProcessor output directory: $AP_OUTPUT_DIR"
echo "[striv-core-m1a] M1a solution filter: $M1A_SLNF"

echo "[striv-core-m1a] Building AssemblyProcessor..."
...
echo "[striv-core-m1a] AssemblyProcessor payload validation passed (size=${file_size} bytes, header=MZ)."

echo "[striv-core-m1a] Building Stri-V Core M1a..."
dotnet build "$M1A_SLNF" -c "$CONFIGURATION" -v minimal \
...
echo "[striv-core-m1a] Build completed successfully."
