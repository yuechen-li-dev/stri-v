...
M1C_SLNF="$REPO_ROOT/build/StriV.PlatformGraphicsBasics.M1c.slnf"

echo "[striv-platform-graphics-basics-m1c] Repo root: $REPO_ROOT"
echo "[striv-platform-graphics-basics-m1c] Configuration: $CONFIGURATION"
echo "[striv-platform-graphics-basics-m1c] Platform: Linux"
echo "[striv-platform-graphics-basics-m1c] Graphics API: Vulkan"
echo "[striv-platform-graphics-basics-m1c] AssemblyProcessor project: $AP_PROJECT"
echo "[striv-platform-graphics-basics-m1c] AssemblyProcessor output directory: $AP_OUTPUT_DIR"
echo "[striv-platform-graphics-basics-m1c] M1c solution filter: $M1C_SLNF"

echo "[striv-platform-graphics-basics-m1c] Building AssemblyProcessor..."
...
echo "[striv-platform-graphics-basics-m1c] AssemblyProcessor payload validation passed (size=${file_size} bytes, header=MZ)."

echo "[striv-platform-graphics-basics-m1c] Building Stri-V Platform + Graphics Basics M1c..."
dotnet build "$M1C_SLNF" -c "$CONFIGURATION" -v minimal \
...
echo "[striv-platform-graphics-basics-m1c] Build completed successfully."
