...
M1D_SLNF="$REPO_ROOT/build/StriV.Input.M1d.slnf"

echo "[striv-input-m1d] Repo root: $REPO_ROOT"
echo "[striv-input-m1d] Configuration: $CONFIGURATION"
echo "[striv-input-m1d] Platform: Linux"
echo "[striv-input-m1d] Graphics API: Vulkan"
echo "[striv-input-m1d] AssemblyProcessor output directory: $AP_OUTPUT_DIR"
echo "[striv-input-m1d] M1d solution filter: $M1D_SLNF"

echo "[striv-input-m1d] Building AssemblyProcessor..."
...
echo "[striv-input-m1d] AssemblyProcessor payload validation passed (size=${file_size} bytes, header=MZ)."

echo "[striv-input-m1d] Building Stri-V Input M1d..."
dotnet build "$M1D_SLNF" -c "$CONFIGURATION" -v minimal \
...
echo "[striv-input-m1d] Build completed successfully."
